...
class DefaultApi(basePath: kotlin.String = "https://mcc-fall-2019-g22.appspot.com/v1") : ApiClient(basePath) {
    ...
    * Assigns users with the Ids in the body to the project with the given id
    * @param projectId  
    * @param users  
    * @return void
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun assignUsersToTask(taskId: kotlin.String, users: InlineObject2) : Unit {
        val localVariableBody: kotlin.Any? = users
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun updateStatusOfTaskWithId(taskId: kotlin.String, taskStatus: InlineObject1) : Unit {
        val localVariableBody: kotlin.Any? = taskStatus
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.PUT,
